  ...
  return (
    <section className='max-padd-container bg-banneroffer bg-center bg-cover w-full'>
        <div className='px-4 py-16 md:py-24 lg:py-44' >
            <h2 className='h2'>Elevate Your Wardrobe</h2>
            <h3 className='medium-32 capitalize font-normal'>Grab <span className='text-secondary'>Your Favourites</span> Before They're Gone!</h3>
            <Link to={'/men'} className='text-white bg-tertiary pl-6 rounded-full flexBetween gap-x-2 medium-16 w-44 mt-10 group'>
                Go to Shop 
