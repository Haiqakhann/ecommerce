...
const Editproduct = () => {
    ...
    const {product,singleproduct,updateproduct} = useContext(Shopcontext)
    ...
    const [stock_s , setStock_s] =useState(product?product.variation[0].size[0].stock:"")
    const [stock_m , setStock_m] =useState(product?product.variation[0].size[2].stock:"")
    ...
    <section>
        <div className='max-padd-container bg-primary py-6'>
            <h2 className='my-6 h3 '>Update Product</h2>
